...
An open source command line tool to turn PNG images into Doom maps.
Created by Ambroise Garel (www.cafedefaune.net)

Project page: akaagar.itch.io/png2wad
Source code: github.com/akaAgar/png2wad
